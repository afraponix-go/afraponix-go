...
-- Demo system data is now handled via SQLite (database/demo-data.sqlite)
-- No sample data needed in init.sql - demo systems use SQLite import for rich, version-controlled sample data