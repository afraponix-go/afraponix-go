...
- Next: Phase 4b — Bed configuration CRUD (create/edit/delete beds, per-type forms) moved into Plants; canonical capacity/area formula + bed_type normalization; remove Settings → Grow Beds.
