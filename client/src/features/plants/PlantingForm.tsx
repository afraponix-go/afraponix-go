...
// page of its own (the operator's simple Planting capture screen), with no
// duplicated logic between the two.
export function PlantingForm({ initialBedId, onDone, onCancel }: { initialBedId?: number; onDone: () => void; onCancel?: () => void }) {
