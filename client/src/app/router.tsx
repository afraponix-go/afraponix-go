    ...
    children: [
      {
        ...
        children: [
          ...
          // Settings (grow-bed config lives under Plants → Beds & Allocation)
          {
            ...
            children: [
              { index: true, element: <SystemOnly><GeneralSettings /></SystemOnly> },
              { path: 'metrics', element: <SystemOnly><MetricsSettings /></SystemOnly> },
              ...
              { path: 'danger', element: <SystemOnly><DangerZone /></SystemOnly> },
            ],
          },
        ],
      },
